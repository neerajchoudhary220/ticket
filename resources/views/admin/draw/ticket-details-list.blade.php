        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('admin.draw.number.details.list', ['draw_id' => $draw->id, 'number' => $number]) }}">Details
                        of Number {{ $number }} of DN-{{ $draw->id }}</a>
                </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-white bg-primary d-flex justify-content-start">
                        ...
                        <h4 class="text-white">Shopkeeper: {{ $ticket->user->name }}</h4>
